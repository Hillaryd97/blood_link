...
<body class="container mx-auto font-poppins bg-red-50">
    ...
    <div class="flex justify-center items-center">
        <div class="m-2">
            ...
            <h2 class="text-2xl text-red-700 text-center">Appointments</h2>
            ...
            <div style="margin: 0  auto" class="px-2">
                <table class="table-fixed text-left " style="width: 90%; margin: 0  auto">
                    ...
                    <?php
                    include 'conn.php';
                    $sql = "SELECT * FROM donor_appointment where donor_id like $id ";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <tbody class="mt-2" style="border-bottom: black solid 2px;">
                                <tr>
                                    <td>
                                        <?php echo $row['hos_location']; ?>
                                    </td>
                                    <td>
                                        <?php echo $row['apt_date']; ?>
                                    </td>
                                    <td>
                                        <?php echo $row['apt_time']; ?>
                                    </td>
                                </tr>
                            </tbody>
                            <?php
