      ...
      <div class="grid grid-cols-2 mt-6">
        <div class="flex flex-col space-y-2.5">
          ...
          <div class="flex items-center text-lg">
            ...
            <input class="font-semibold bg-red-50 text-lg" type="text" readonly value=" <?php echo $row['dob']; ?>"
              name="dob">
          </div>
          <div class="flex items-center text-lg">
            <label class=""> Height: </label>
            <input class="font-semibold bg-red-50 text-lg" type="text" readonly value=" <?php echo $row['height']; ?>cm"
              name="height">
          </div>
          <div class="flex items-center text-lg">
            <label class=""> Weight: </label>
            <input class="font-semibold bg-red-50 text-lg" type="text" readonly value=" <?php echo $row['weight']; ?>kg"
              name="weight">
          </div>
          <div class="flex items-center text-lg">
            <label class=""> Genotype: </label>
            <input class="font-semibold bg-red-50 text-lg" type="text" readonly value=" <?php echo $row['genotype']; ?>"
              name="genotype">
          </div>
          <div class="flex items-center text-lg">
            <label class=""> Blood Group: </label>
            <input class="font-semibold bg-red-50 text-lg" type="text" readonly value=" <?php echo $row['bgroup']; ?>"
              name="bgroup">
          </div>
          <div class="flex items-center text-lg">
        ...
        <form action="donor_choice.php" method="POST" class="flex flex-col space-y-3 items-center justify-center">
          <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
          <button type="submit" name="donate"
            class="bg-blue-700 text-white py-3 px-3 rounded-lg hover:bg-blue-500 duration-300 text-lg">Donate Blood
            <br><span class="text-sm">Give blood to those who need it</span></button>
          <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
          <button type="submit" name="appointments"
            class="bg-blue-700 text-white w-36 py-3 px-3 rounded-lg hover:bg-blue-500 duration-300 text-lg">Appointments
            <br><span class="text-sm">See your scheduled appointments and history</span></button>
          <!-- <input type="hidden" name="id" value="<?php echo $row['id'] ?>"> -->
