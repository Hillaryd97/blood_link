    ...
    <div class="m-20 border-red-100 shadow-lg w-2/6 border p-6 rounded-lg">
      ...
      <form class="w-full" action="validation.php" method="POST">
        ...
        <div class="text-center flex flex-col justify-center items-center">
          ...
          <a href="../donor/signup.php"
            class="bg-blue-700 text-white mt-2 py-1 w-fit px-2 rounded-lg hover:bg-blue-500">Login as Donor</a>
            <a href="../requester/login.php" class="outline text-sm outline-blue-700 text-blue-700 mt-2 py-1 w-4/6 rounded-lg hover:bg-blue-500" style="">
            Login as a Requester</a>
        </div>
      </form>
    </div>
  </div>
