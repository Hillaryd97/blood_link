...
<body class="container mx-auto font-poppins bg-red-50">
    ...
    <div class="flex justify-center items-center">
        <div class="m-2">
            ...
            <h2 class="text-2xl text-red-700 text-center">Request History</h2>
            <p class="mb-2 text-center text-sm">~ View request history ~</p>
            ...
            <div style="margin: 0  auto" class="">
                <table class="text-left " style="width: 100%; margin: 0  auto">
                    ...
                    <?php
                    include 'conn.php';
                    $sql = "SELECT * FROM request_records where hospital_id like $id ";
